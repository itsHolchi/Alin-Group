...
export default function Services() {
  return (
    <section id="services" className="pt-4 pb-20 bg-black/80">
      <div className="container mx-auto px-4"> {/*container for the grids*/}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {services.map((service, index) => (
            <div key={index} className="flex flex-col items-center bg-white/35 text-center group rounded-lg p-8 transition-all duration-300">
              <div className="relative w-32 h-32 mb-6 rounded-full bg-white p-4 group-hover:bg-alin-gold transition-all duration-300">
                <Image
                  src={service.image}
                  alt={service.title}
                  fill
